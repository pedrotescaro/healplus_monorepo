      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-4 sm:p-6 md:p-8">
        <div className="w-full max-w-sm sm:max-w-md space-y-6 sm:space-y-8">
          ...
          <div className="text-center space-y-2">
            <h2 className="text-2xl sm:text-3xl font-bold text-foreground">{t.createAccount}</h2>
            <p className="text-sm sm:text-base text-muted-foreground">{t.createAccountPrompt}</p>
          </div>
